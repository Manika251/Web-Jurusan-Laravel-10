...
<head>
    ...
    <title>{{ config('app.name', 'Jurusan Kita') }}</title>

    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.bunny.net">
    <link href="[https://fonts.bunny.net/css?family=Nunito](https://fonts.bunny.net/css?family=Nunito)" rel="stylesheet">
