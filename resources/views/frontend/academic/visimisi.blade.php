...
<!-- LOGIKA GAMBAR & PETA -->
@php
$gedungImage = isset($web_config['_hero_image'])
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="text-secondary lh-lg mb-4">
                    ...
                    <p>
                        Sejak awal berdiri, kami memegang teguh komitmen untuk menyediakan fasilitas pendidikan terbaik, kurikulum yang adaptif, serta tenaga pengajar yang berdedikasi tinggi. Setiap langkah kami didedikasikan untuk masa depan smahasiswa jurusan kami.
                    </p>
                </div>
