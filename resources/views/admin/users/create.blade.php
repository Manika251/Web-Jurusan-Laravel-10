    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold text-primary">Tambah Admin Baru</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.users.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="contoh@jurusan.com">
        ...
        <div class="col-md-4">
            <div class="alert alert-info">
                ...
                <p>Admin yang ditambahkan akan memiliki akses penuh ke panel ini, termasuk mengelola berita, galeri, dan data akademik.</p>
                <hr>
                <small>Pastikan email aktif dan password cukup kuat.</small>
            </div>
        </div>
    </div>
</div>
